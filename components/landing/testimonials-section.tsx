...
const testimonials = [
  {
    quote: "Biển mây ở Ô Quy Hồ thực sự đẹp như tranh vẽ. Đây là trải nghiệm tuyệt vời nhất trong chuyến du lịch Tây Bắc của tôi.",
    author: "Nguyễn Minh Anh",
    role: "Travel Blogger",
    company: "Hà Nội",
    metric: { value: "5/5", label: "Đánh giá" },
  },
  {
    quote: "Con đèo dài nhưng cảnh sắc hai bên đường tuyệt đẹp. Mỗi khúc cua là một bức tranh thiên nhiên mới.",
    author: "Trần Văn Hùng",
    role: "Phượt thủ",
    company: "Sài Gòn",
    metric: { value: "10+", label: "Lần quay lại" },
  },
  {
    quote: "Ẩm thực Tây Bắc ở đây rất ngon và đặc sắc. Thắng cố và xôi ngũ sắc là những món không thể bỏ qua.",
    author: "Lê Thu Hương",
    role: "Food Reviewer",
    company: "Đà Nẵng",
    metric: { value: "50+", label: "Món đã thử" },
  },
  {
    quote: "Cắm trại qua đêm ở cổng trời là trải nghiệm đáng nhớ nhất. Bầu trời sao ở đây đẹp không thể tưởng tượng.",
    author: "Phạm Đức Minh",
    role: "Photographer",
    company: "Hải Phòng",
    metric: { value: "1000+", label: "Ảnh đẹp" },
  },
];
...
export function TestimonialsSection() {
  ...
  return (
    <section ref={sectionRef} className="relative py-32 lg:py-40 bg-foreground text-background overflow-hidden">
      {/* Background pattern */}
      <div className="absolute inset-0 text-[10px] text-background/[0.02] leading-tight overflow-hidden whitespace-pre select-none">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            <span className="inline-flex items-center gap-3 text-sm text-background/40 mb-4">
            ...
            <h2 className={`text-4xl lg:text-5xl font-display transition-all duration-1000 ${
              ...
              Du khách
              <span className="text-background/40"> chia sẻ.</span>
            </h2>
          </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center gap-6">
            ...
            <div className="mt-4 pt-6 border-t border-background/10">
              <span className="text-xs text-background/30 uppercase tracking-widest block mb-4">
                Nơi ở
              </span>
